...
class RegistrationTest(TestCase):
    def test_registration(self):
        ...
        self.assertContains(response, "We sent you an email to test@example.com.")
    ...
    def test_existing_user(self):
        ...
        self.assertTrue(
            re.match(r"http://testserver/er/test@example.com:\d+:\w+:", url)
        )
    ...
    def test_already_existing_email(self):
        ...
        self.assertContains(
            response, "Did you want to reset your password?", status_code=200
        )
